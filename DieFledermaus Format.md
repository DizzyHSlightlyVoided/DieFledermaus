...
* `RsaSig` - *One parameter.* The stream is digitally signed with RSA, using an SHA-512 hash (or SHA-3/512 fi `SHA3` is enabled) of the uncompressed data and PKCS 1.5 padding.
